<template>
    <div class="h-[51.1rem] grid grid-cols-3 gap-12 mb-28">
        <img class="col-span-2" src="../assets/images/image-web-3-desktop.jpg" alt="web-3">
        <div class="bg-blue-vdark row-span-2 pt-[3.2rem] px-[2.4rem]">
        ...
        <h1 class="text-blue-vdark font-extrabold text-[5.6rem] leading-[5.6rem]">The Bright Future of Web 3.0?</h1>
        <div class="flex flex-col justify-between">
            <p class="text-2xl text-blue-grayishdark font-normal">
